...
FontLoader {
    id: customFont
    source: "Fonts/8bitlim.ttf"   // path relative to the theme folder
}
...
//    id: osLogo
//    source: config.Logo
    // Vertically aligned with the form
//    anchors.verticalCenter: form.verticalCenter

    // Stick to the side of the form facing the free space
//    anchors.left: (config.FormPosition == "left") ? form.right : undefined
//    anchors.right: (config.FormPosition == "right") ? form.left : undefined

//    anchors.margins: 60   // distance between form edge and logo

    // Scaling: 30% of free space width, capped at 400px
